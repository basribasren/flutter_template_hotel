...
import 'package:basri_s_application17/presentation/welcome_screen/welcome_screen.dart';
import 'package:basri_s_application17/presentation/onboarding_one_screen/onboarding_one_screen.dart';
import 'package:basri_s_application17/presentation/onboarding_two_screen/onboarding_two_screen.dart';
import 'package:basri_s_application17/presentation/onboarding_three_screen/onboarding_three_screen.dart';
import 'package:basri_s_application17/presentation/let_s_you_in_screen/let_s_you_in_screen.dart';
import 'package:basri_s_application17/presentation/sign_up_blank_screen/sign_up_blank_screen.dart';
import 'package:basri_s_application17/presentation/sign_in_screen/sign_in_screen.dart';
import 'package:basri_s_application17/presentation/fill_profile_screen/fill_profile_screen.dart';
import 'package:basri_s_application17/presentation/forgot_password_screen/forgot_password_screen.dart';
import 'package:basri_s_application17/presentation/forgot_password_type_otp_screen/forgot_password_type_otp_screen.dart';
import 'package:basri_s_application17/presentation/forgot_password_filled_type_screen/forgot_password_filled_type_screen.dart';
import 'package:basri_s_application17/presentation/create_new_password_screen/create_new_password_screen.dart';
import 'package:basri_s_application17/presentation/home_screen_container_screen/home_screen_container_screen.dart';
import 'package:basri_s_application17/presentation/recently_booked_screen/recently_booked_screen.dart';
import 'package:basri_s_application17/presentation/notifications_screen/notifications_screen.dart';
import 'package:basri_s_application17/presentation/my_bookmarks_screen/my_bookmarks_screen.dart';
import 'package:basri_s_application17/presentation/hotel_details_screen/hotel_details_screen.dart';
import 'package:basri_s_application17/presentation/gallery_screen/gallery_screen.dart';
import 'package:basri_s_application17/presentation/location_screen/location_screen.dart';
import 'package:basri_s_application17/presentation/select_date_guest_screen/select_date_guest_screen.dart';
import 'package:basri_s_application17/presentation/booking_name_tab_container_screen/booking_name_tab_container_screen.dart';
import 'package:basri_s_application17/presentation/choose_payment_method_screen/choose_payment_method_screen.dart';
import 'package:basri_s_application17/presentation/add_new_card_screen/add_new_card_screen.dart';
import 'package:basri_s_application17/presentation/card_added_screen/card_added_screen.dart';
import 'package:basri_s_application17/presentation/confirm_payment_screen/confirm_payment_screen.dart';
import 'package:basri_s_application17/presentation/view_ticket_screen/view_ticket_screen.dart';
import 'package:basri_s_application17/presentation/refund_method_screen/refund_method_screen.dart';
import 'package:basri_s_application17/presentation/edit_profile_screen/edit_profile_screen.dart';
import 'package:basri_s_application17/presentation/notification_settings_screen/notification_settings_screen.dart';
import 'package:basri_s_application17/presentation/security_screen/security_screen.dart';
import 'package:basri_s_application17/presentation/app_navigation_screen/app_navigation_screen.dart';
